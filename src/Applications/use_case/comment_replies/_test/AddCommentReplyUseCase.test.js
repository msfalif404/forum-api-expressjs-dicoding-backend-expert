...
describe('AddCommentReplyUseCase', () => {
  ...
  it('should orchestrating the add comment reply', async () => {
    ...
    // Assert AddedCommentReply properties
    expect(addedComment.id).toBe('reply-123');
    ...
    expect(mockCommentRepository.getCommentById).toBeCalledWith(useCaseCommentId.id);
